...
import com.vladmihalcea.spring.demo.service.jdbctemplate.MultipleQueryForumService;
...
public class JdbcTemplateMultipleQueriesDemoTest extends BaseMultilevelDemoTest {

	protected final Logger LOGGER = LoggerFactory.getLogger(getClass());

	@Autowired
	@Qualifier("JdbcTemplateMultipleQueryForumService")
	private MultipleQueryForumService forumService;
