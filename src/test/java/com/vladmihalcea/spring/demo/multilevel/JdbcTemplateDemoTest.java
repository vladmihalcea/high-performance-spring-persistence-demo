...
import com.vladmihalcea.spring.demo.service.jdbctemplate.ForumService;
...
public class JdbcTemplateDemoTest extends BaseMultilevelDemoTest {

	protected final Logger LOGGER = LoggerFactory.getLogger(getClass());

	@Autowired @Qualifier("JdbcTemplateForumService")
