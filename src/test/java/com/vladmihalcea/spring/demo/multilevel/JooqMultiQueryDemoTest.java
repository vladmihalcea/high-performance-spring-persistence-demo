...
import com.vladmihalcea.spring.demo.service.jooq.ForumMultiQueryService;
...
/**
 * Verifies the jOOQ multi-query strategy (2 queries: Posts+Tags, PostComments+Votes).
 *
 * @author Vlad Mihalcea
 */
public class JooqMultiQueryDemoTest extends BaseMultilevelDemoTest {

	protected final Logger LOGGER = LoggerFactory.getLogger(getClass());

	@Autowired @Qualifier("JooqMultiQueryForumService")
	private ForumMultiQueryService forumService;

	@Test
	public void testMultiLevelFetchingWithMultipleQueries() {
		addHierarchicalData();
