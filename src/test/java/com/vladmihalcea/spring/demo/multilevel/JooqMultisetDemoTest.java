...
import com.vladmihalcea.spring.demo.service.jooq.ForumService;
...
public class JooqMultisetDemoTest extends BaseMultilevelDemoTest {

	protected final Logger LOGGER = LoggerFactory.getLogger(getClass());

	@Autowired @Qualifier("JooqForumService")
